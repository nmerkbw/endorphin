        ...
        <div class="col-6">
            <form action="/user/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="userEmail" name="userEmail" placeholder="输入邮箱">
                </div>
                <div class="form-group">
                    <label for="userSex">性别</label>
                    <input type="text" class="form-control" id="userSex" name="userSex" placeholder="输入性别">
                </div>
                <div class="form-group">
